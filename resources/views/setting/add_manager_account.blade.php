                ...
                <div class="row">
                    ...
                    <div class="col-6 mt-">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="password">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" aria-label="Default select example" name="">
