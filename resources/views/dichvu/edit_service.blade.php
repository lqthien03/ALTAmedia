        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="201" name="ma_device">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Tên dịch vụ : *</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Khám tim mạch" name="ma_device">
                </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Mô tả dịch vụ" name="ma_device" style="height:200px">
