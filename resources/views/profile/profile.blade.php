                ...
                <div class="col-4 box_1">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput"
                            placeholder="quocthien0404@gmail.com" name="" value="{{ Auth::user()->email }}">
                    </div>
                </div>
                <div class="col-4 box_2">
                    <div class=" mb-3">
                        <label for="formGroupExampleInput" class="form-label">Tên đăng nhập</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="thien"
                            name="" value="{{ Auth::user()->name_dangnhap }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="bác sĩ"
                            name="" value="{{ Auth::user()->role->name_role }}">
                    </div>
                </div>
            </div>
        </div>
